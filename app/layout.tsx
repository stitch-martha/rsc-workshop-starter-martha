...
export default async function RootLayout({ children }: { children: React.ReactNode }) {
  // This is not the best way to fetch data, but it's good enough for this workshop
  // The talk tomorrow will cover better ways to fetch data in React Server Components
